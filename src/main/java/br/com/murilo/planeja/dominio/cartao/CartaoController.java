...
public class CartaoController {
    ...
    @PostMapping
    public ResponseEntity<CartaoDetalhes> criar(@RequestBody @Valid CartaoForm dto) {
        CartaoDetalhes detalhes = service.criar(dto);
    ...
    @PutMapping("{id}")
    public ResponseEntity<Void> atualizar(@PathVariable("id") UUID id, @RequestBody CartaoForm dadosAtualizacao) {
